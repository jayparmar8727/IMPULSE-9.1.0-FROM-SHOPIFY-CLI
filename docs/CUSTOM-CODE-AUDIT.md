...
| **Brass `#bc843f` / `#d8ae82` small text** (eyebrows, labels, metal tags, prices on light bg ≈ 3:1, below AA) | Brass is the intentional brand accent | `kw-section-conventions` memory: *"brass is intentional accent, DO NOT change"* |
